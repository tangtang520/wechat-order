...
function odd(){
    ...
    if((hour001==3&&(minute001==1))){
        var httpArry = ['/interface?command=endMenu',
            '/interface?command=weixinDel',
            '/interface?command=weixinImgMenuDel',
            '/interface?command=senMenuPer',
            '/interface?command=noDoMenu'
        ]
    ...
    "button":[
        {
            ...
            "sub_button":[
                ...
                },
                {
                    "type":"view",
                    "name":"今日菜单",
                    "url":"/page?command=allMenu"
                },
                {
                    "type":"view",
                    "name":"图片菜单",
                    "url":"/page?command=imgMenu"
                },
                {
                    "type":"view",
                    "name":"文字菜单",
                    "url":"/page?command=txtMenu"
                },
                {
                    "type":"click",
                    "name":"时间",
            ...
            "sub_button":[
                {
                    "type":"view",
                    "name":"本微信后台说明",
                    "url":"/page?command=sayInfo"
                },
                {
                    "type":"view",
                    "name":"注册信息",
                    "url":"/page?command=newPerMessage"
                },
                {
                    "type":"view",
                    "name":"上传菜单",
                    "url":"/page?command=doMenu"
                },
                {
                    "type":"view",
                    "name":"通讯录",
                    "url":"/page?command=doBook"
                },
                {
                    "type":"view",
                    "name":"点餐",
                    "url":"/page?command=doAllFood"
                }
            ]
        }
    ]
